...
![Import]({{ site.url }}/v2-documentation/images/configuring_ide_eclipse_1.png)

![Select]({{ site.url }}/v2-documentation/images/configuring_ide_eclipse_2.png)
...
![Select]({{ site.url }}/v2-documentation/images/configuring_ide_eclipse_maven_processor.png)
...
![Right-click]({{ site.url }}/v2-documentation/images/configuring_ide_eclipse_3.png)

![Exclude]({{ site.url }}/v2-documentation/images/configuring_ide_eclipse_4.png)
...
![Right-click]({{ site.url }}/v2-documentation/images/configuring_ide_eclipse_5.png)

![Exclude]({{ site.url }}/v2-documentation/images/configuring_ide_eclipse_6.png)

![Multiple select]({{ site.url }}/v2-documentation/images/configuring_ide_eclipse_7.png)
