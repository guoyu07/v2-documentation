...
If you want more information on our Elasticsearch support, we have a [specific documentation available](http://{{ site.url }}/v2-documentation/using-elasticsearch/).
