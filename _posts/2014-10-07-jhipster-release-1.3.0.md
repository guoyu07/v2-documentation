...
- The entity sub-generator has been greatly improved, and can now generate a whole CRUD application, from database to HTML. Please check our [updated documentation](http://{{ site.url }}/v2-documentation/creating-an-entity/).
