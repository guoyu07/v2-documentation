...
Everybody has been waiting for this for a long time, our [marketplace]({{ site.url }}/v2-documentation/modules/marketplace/) is now open!

You can code your own modules, with all the power of the JHipster sub-generators, but without having to be part of the project: anybody can code and publish them easily, just follow our [documentation here]({{ site.url }}/v2-documentation/modules/creating-a-module/).
