...
- We have a new "fast" profile, which is documented [here](http://{{ site.url }}/v2-documentation/profiles/). You can expect to start up a JHipster application in 4 seconds!
