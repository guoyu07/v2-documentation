...
- We have early support for deploying a JHipster application to the cloud in one command! We currently support [Heroku]({{ site.url }}/v2-documentation/heroku/) and [Openshift]({{ site.url }}/v2-documentation/openshift/). Please give them a try, but remember, this is an early release!
